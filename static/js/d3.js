...
function(t) {
    ...
    function l(t, n) {
        function e(e) {
            ...
            e !== w && (M = M.transition(e), T = T.transition(e), S = S.transition(e), E = E.transition(e), N = N.transition(e).attr("opacity", Ys).attr("transform",
            function(t) {
                return isFinite(t = b(t)) ? _(t) : this.getAttribute("transform")
            }), k.attr("opacity", Ys).attr("transform",
            function(t) {
            ...
            T.attr("opacity", 1).attr("transform",
            function(t) {
                return _(b(t))
            }),
            S.attr(v + "2", d * l),
    ...
    function C(t, n, e, r, i, o) {
        for (var u, a = 0,
        c = n.length,
        s = o.length; a < s; ++a)(u = n[a]) ? (u.__data__ = o[a], r[a] = u) : e[a] = new A(t, o[a]);
    ...
    function K(t, n) {
        return function() { (n.apply(this, arguments) ? Z: G)(this, t)
        }
    }
    function tt() {
        this.textContent = ""
    ...
    function rn(t, n, e, r) {
        ...
        return function(n, e) {
            ...
            function(t) {
                for (var n, e = -1,
                o = i.length; ++e < o;) r[(n = i[e]).i] = n.x(t);
                return r.join("")
            }
        }
    }
    ...
    function vn() {
        ln(),
        ++Nl;
        for (var t, n = Zf; n;)(t = Cl - n._time) >= 0 && n._call.call(null, t),
        n = n._next; --Nl
    }
    function _n() {
        Cl = (Al = Pl.now()) + zl,
    ...
    function yn() {
        for (var t, n, e = Zf,
        r = 1 / 0; e;) e._call ? (r > e._time && (r = e._time), t = e, e = e._next) : (n = e._next, e._next = null, e = t ? t._next = n: Zf = n);
        Gf = t,
        mn(r)
    }
    function mn(t) {
    ...
    function oe(t, n) {
        for (var e; ! (e = t.__transition) || !(e = e[n]);) if (! (t = t.parentNode)) return yh.time = ln(),
        yh;
        return e
    }
    function ue() {
    ...
    function he(n) {
        ...
        function u() {
            function e() {
                var t = nf(w); ! L || x || b || (Math.abs(t[0] - U[0]) > Math.abs(t[1] - U[1]) ? b = !0 : x = !0),
                U = t,
                m = !0,
                wh(),
                o()
            ...
            if (f.apply(this, arguments)) {
                ...
                if (t.event.touches) O.on("touchmove.brush", e, !0).on("touchend.brush touchcancel.brush", u, !0);
                    ...
                    var I = ff(t.event.view).on("keydown.brush",
                    function() {
    ...
    function Pe(t, n, e, r) {
        ...
        t;
        for (; p.length;) if ((s = n >= (o = (v + g) / 2)) ? v = o: g = o, (f = e >= (u = (_ + y) / 2)) ? _ = u: y = u, i = p, !(p = p[l = f << 1 | s])) return i[l] = d,
        t;
    ...
    function Or(t, n, e, r, i, o) {
        if (e) {
            ...
            for (var s, f = i; r > 0 ? f > o: f < o; f -= c) s = ur([u, -a * md(f), -a * Td(f)]),
            t.point(s[0], s[1])
        }
    }
    function Fr(t, n) { (n = ar(n))[0] -= t,
        hr(n);
        var e = Ze( - n[1]);
    ...
    function Xr(t, n, e, r) {
        ...
        return function(u) {
            ...
            function s() {
                for (var n = 0,
                e = 0,
                i = h.length; e < i; ++e) for (var o, u, a = h[e], c = 1, s = a.length, f = a[0], l = f[0], p = f[1]; c < s; ++c) o = l,
                u = p,
                l = (f = a[c])[0],
                p = f[1],
            ...
            T = {
                ...
                polygonEnd: function() {
                    var t = s(),
                    n = b && t,
                    e = (l = Ps(l)).length; (n || e) && (u.polygonStart(), n && (u.lineStart(), o(null, null, 1, u), u.lineEnd()), e && Kd(l, a, t, o, u), u.polygonEnd()),
                    w = u,
                    l = h = p = null
                }
            };
    ...
    function Si(t, n) {
        function e(r, i, o, u, a, c, s, f, l, h, p, d, v, _) {
            ...
            if (m > 4 * n && v--) {
                ...
                A = S - r,
                C = E - i,
                z = y * A - g * C; (z * z / m > n || _d((g * A + y * C) / m - .5) > .3 || u * h + a * p + c * d < jv) && (e(r, i, o, u, a, c, S, E, N, x /= M, b /= M, w, v, _), _.point(S, E), e(S, E, N, x, b, w, s, f, l, h, p, d, v, _))
            }
        }
        return function(n) {
            function r(e, r) {
    ...
    function io(t, n) {
        ...
        s = [a];
        for (null == n && (n = oo); e = s.pop();) if (c && (e.value = +e.data.value), (i = n(e.data)) && (u = i.length)) for (e.children = new Array(u), o = u - 1; o >= 0; --o) s.push(r = e.children[o] = new co(i[o])),
        r.parent = e,
        r.depth = e.depth + 1;
    ...
    function fo(t, n) {
        var e, r;
        if (po(n, t)) return [n];
        for (e = 0; e < t.length; ++e) if (lo(n, t[e]) && po(go(t[e], n), t)) return [t[e], n];
        for (e = 0; e < t.length - 1; ++e) for (r = e + 1; r < t.length; ++r) if (lo(go(t[e], t[r]), n) && lo(go(t[e], n), t[r]) && lo(go(t[r], n), t[e]) && po(yo(t[e], t[r], n), t)) return [t[e], t[r], n];
        throw new Error
    }
    function lo(t, n) {
        var e = t.r - n.r,
    ...
    function po(t, n) {
        for (var e = 0; e < n.length; ++e) if (!ho(t, n[e])) return ! 1;
        return ! 0
    }
    function vo(t) {
        switch (t.length) {
    ...
    function Mo(t) {
        ...
        t: for (a = 3; a < i; ++a) {
            ...
            for (r.previous = n, r.next = e, n.next = e.previous = e = r, o = bo(n); (r = r.next) !== e;)(u = bo(r)) < o && (n = r, o = u);
            e = n.next
        }
        for (n = [e._], r = e; (r = r.next) !== e;) n.push(r._);
        for (r = Jv(n), a = 0; a < i; ++a) n = t[a],
        n.x -= r.x,
        n.y -= r.y;
        return r.r
    }
    ...
    function Ao(t, n) {
        return function(e) {
            if (r = e.children) {
                ...
                if (o = Mo(r), a) for (i = 0; i < u; ++i) r[i].r -= a;
                e.r = o + a
            }
        }
    }
    ...
    function Io(t) {
        for (var n, e, r, i, o, u = new Fo(t, 0), a = [u]; n = a.pop();) if (r = n._.children) for (n.children = new Array(o = r.length), i = o - 1; i >= 0; --i) a.push(e = n.children[i] = new Fo(r[i], i)),
        e.parent = n;
    ...
    function mu() {
        ...
        e.ticks = function(t) {
            var n, e = r(),
            a = e[0],
            c = e[e.length - 1]; (n = c < a) && (h = a, a = c, c = h);
            var s, f, l, h = o(a),
            p = o(c),
            d = null == t ? 10 : +t,
            v = [];
    ...
    function wu() {
        ...
        n.domain = function(n) {
            ...
            e = [];
            for (var r, i = 0,
            o = n.length; i < o; ++i) null == (r = n[i]) || isNaN(r = +r) || e.push(r);
            return e.sort(ls),
            t()
        },
        n.range = function(n) {
    ...
    function Wa(t) {
        function n() {
            ...
            c = e.apply(this, a),
            s = r.apply(this, a);
            if (u || (u = n = ve()), t(u, +i.apply(this, (a[0] = c, a)), +o.apply(this, a), +i.apply(this, (a[0] = s, a)), +o.apply(this, a)), n) return u = null,
            n + "" || null
        }
        var e = $a,
        r = Va,
    ...
    function Yc() {
        for (var t, n, e, r, i = 0,
        o = lm.length; i < o; ++i) if ((t = lm[i]) && (r = (n = t.halfedges).length)) {
            var u = new Array(r),
            a = new Array(r);
            for (e = 0; e < r; ++e) u[e] = e,
            a[e] = Oc(t, pm[n[e]]);
    ...
    function Bc(t, n, e, r) {
        ...
        g = !0;
        for (i = 0; i < _; ++i) if (o = lm[i]) {
            for (u = o.site, a = (c = o.halfedges).length; a--;) pm[c[a]] || c.splice(a, 1);
            for (a = 0, s = c.length; a < s;) d = (p = Ic(o, pm[c[a]]))[0],
            v = p[1],
            l = (f = Fc(o, pm[c[++a % s]]))[0],
            h = f[1],
            (Math.abs(d - l) > _m || Math.abs(v - h) > _m) && (c.splice(a, 0, pm.push(Pc(u, p, Math.abs(d - t) < _m && r - v > _m ? [t, Math.abs(l - t) < _m ? h: r] : Math.abs(v - r) < _m && e - d > _m ? [Math.abs(h - r) < _m ? l: e, r] : Math.abs(d - e) < _m && v - n > _m ? [e, Math.abs(l - e) < _m ? h: n] : Math.abs(v - n) < _m && d - t > _m ? [Math.abs(h - n) < _m ? l: t, n] : null)) - 1), ++s);
            s && (g = !1)
        }
        if (g) {
            var y, m, x, b = 1 / 0;
        ...
        if (n && e) {
            ...
            if (r !== o) {
                ...
                if (! (h >= -gm)) {
                    ...
                    t.circle = g;
                    for (var y = null,
                    m = hm._; m;) if (g.y < m.y || g.y === m.y && g.x <= m.x) {
                        if (!m.L) {
                            y = m.P;
                            break
                        }
    ...
    function Zc(t) {
        ...
        a = [t];
        Wc(t);
        for (var c = o; c.circle && Math.abs(e - c.circle.x) < _m && Math.abs(r - c.circle.cy) < _m;) o = c.P,
        a.unshift(c),
        Wc(c),
        c = o;
        a.unshift(c),
        Xc(c);
        for (var s = u; s.circle && Math.abs(e - s.circle.x) < _m && Math.abs(r - s.circle.cy) < _m;) u = s.N,
        a.push(s),
        Wc(s),
        s = u;
        a.push(s),
    ...
    function Gc(t) {
        for (var n, e, r, i, o = t[0], u = t[1], a = fm._; a;) if ((r = Jc(a, u) - o) > _m) a = a.L;
        else {
            if (! ((i = o - Qc(a, u)) > _m)) {
    ...
    function ns(t, n) {
        ...
        for (pm = [], lm = new Array(t.length), fm = new kc, hm = new kc;;) if (i = sm, o && (!i || o[1] < i.y || o[1] === i.y && o[0] < i.x)) o[0] === e && o[1] === r || (Gc(o), e = o[0], r = o[1]),
        o = t.pop();
        else {
            if (!i) break;
            Zc(i.arc)
    ...
    gs = function(t, n) {
        ...
        a = 0,
        c = 0;
        if (null == n) for (; ++u < i;) isNaN(e = _s(t[u])) || (c += (r = e - a) * (e - (a += r / ++o)));
        else for (; ++u < i;) isNaN(e = _s(n(t[u], u, t))) || (c += (r = e - a) * (e - (a += r / ++o)));
        if (o > 1) return c / (o - 1)
    },
    ys = function(t, n) {
        var e = gs(t, n);
    ...
    Ls = function(t) {
        ...
        for (var n = -1,
        e = Rs(t, o), r = new Array(e); ++n < e;) for (var i, u = -1,
        ...
        on: function(t, n) {
            ...
            u = i.length; {
                if (! (arguments.length < 2)) {
                    ...
                    for (; ++o < u;) if (e = (t = i[o]).type) r[e] = _(r[e], t.name, n);
    ...
    lf = function(t, n, e) {
        ...
        for (var r, i = 0,
        o = n ? n.length: 0; i < o; ++i) if ((r = n[i]).identifier === e) return tf(t, r);
        return null
    },
    hf = function() {
    ...
    sl = function(t, n) {
        ...
        a = [],
        c = [];
        for (t += "", n += ""; (e = al.exec(t)) && (r = cl.exec(n));)(i = r.index) > o && (i = n.slice(o, i), a[u] ? a[u] += i: a[++u] = i),
    ...
    Gn.prototype = Jn.prototype = {
        ...
        select: function(t) {
            ...
            i = r.length,
            o = new Array(i), u = 0; u < i; ++u) for (var a, c, s = r[u], f = s.length, l = o[u] = new Array(f), h = 0; h < f; ++h)(a = s[h]) && (c = t.call(a, a.__data__, h, s)) && ("__data__" in a && (c.__data__ = a.__data__), l[h] = c, Hl(l[h], n, e, h, l, wn(a, e)));
        ...
        transition: function() {
            ...
            n = this._id,
            e = Qn(), r = this._groups, i = r.length, o = 0; o < i; ++o) for (var u, a = r[o], c = a.length, s = 0; s < c; ++s) if (u = a[s]) {
                var f = wn(u, n);
                Hl(u, t, e, s, a, {
    ...
    dt.prototype.transition = function(t) {
        ...
        for (var r = this._groups,
        i = r.length,
        o = 0; o < i; ++o) for (var u, a = r[o], c = a.length, s = 0; s < c; ++s)(u = a[s]) && Hl(u, t, n, s, a, e || oe(u, n));
    ...
    hp.copy = function() {
        ...
        r = this._root;
        if (!r) return e;
        if (!r.length) return e._root = De(r),
        e;
        for (t = [{
            source: r,
    ...
    hp.find = function(t, n, e) {
        ...
        d = [],
        v = this._root;
        for (v && d.push(new lp(v, f, l, h, p)), null == e ? e = 1 / 0 : (f = t - e, l = n - e, h = t + e, p = n + e, e *= e); c = d.pop();) if (! (! (v = c.node) || (i = c.x0) > h || (o = c.y0) > p || (u = c.x1) < f || (a = c.y1) < l)) if (v.length) {
            var _ = (i + u) / 2,
            g = (o + a) / 2;
    ...
    hp.visit = function(t) {
        var n, e, r, i, o, u, a = [],
        c = this._root;
        for (c && a.push(new lp(c, this._x0, this._y0, this._x1, this._y1)); n = a.pop();) if (!t(c = n.node, r = n.x0, i = n.y0, o = n.x1, u = n.y1) && c.length) {
            var s = (r + o) / 2,
            f = (i + u) / 2; (e = c[3]) && a.push(new lp(e, s, f, o, u)),
    ...
    hp.visitAfter = function(t) {
        ...
        for (this._root && e.push(new lp(this._root, this._x0, this._y0, this._x1, this._y1)); n = e.pop();) {
            ...
            if (i.length) {
                ...
                s = n.y1,
                f = (u + c) / 2,
                l = (a + s) / 2; (o = i[0]) && e.push(new lp(o, u, a, f, l)),
        ...
        function n(t) {
            function n(t) {
                ...
                t = "";
                    ...
                    var b = (t = +t) < 0;
                    if (t = y(Math.abs(t), d), b && 0 == +t && (b = !1), f = (b ? "(" === s ? s: "-": "-" === s || "(" === s ? "": s) + f, x = x + ("s" === v ? Np[8 + pp / 3] : "") + (b && "(" === s ? ")": ""), m) for (n = -1, r = t.length; ++n < r;) if (48 > (u = t.charCodeAt(n)) || u > 57) {
    ...
    Ed = {
        ...
        FeatureCollection: function(t, n) {
            ...
            r = -1,
            i = e.length; ++r < i;) Ke(e[r].geometry, n)
        }
    },
    Ad = {
        Sphere: function(t, n) {
        ...
        if (t.forEach(function(t) {
            if (! ((n = t.length - 1) <= 0)) {
                ...
                if (Qd(r, u)) {
                    ...
                    i.lineEnd()
                } else a.push(e = new Ir(r, t, null, !0)),
    ...
    nv = function(t, n) {
        ...
        tv.reset();
        for (var a = 0,
        c = t.length; a < c; ++a) if (f = (s = t[a]).length) for (var s, f, l = s[f - 1], h = l[0], p = l[1] / 2 + hd, d = Td(p), v = md(p), _ = 0; _ < f; ++_, h = y, d = x, v = b, l = g) {
            var g = s[_],
            y = g[0],
            m = g[1] / 2 + hd,
            x = Td(m),
            ...
            if (tv.add(yd(k * M * Td(T), v * b + k * md(T))), o += N ? w + M * pd: w, N ^ h >= e ^ y >= e) {
                ...
                var E = sr(i, S);
                hr(E);
                var A = (N ^ w >= 0 ? -1 : 1) * Ge(E[2]); (r > A || r === A && (S[0] || S[1])) && (u += N ^ w >= 0 ? 1 : -1)
            }
        }
        ...
        function(t) {
            ...
            return {
                ...
                point: function(l, h) {
                    ...
                    if (!i && (s = c = v) && t.lineStart(), v !== c && (!(p = e(i, d)) || Qd(i, p) || Qd(d, p)) && (d[0] += sd, d[1] += sd, v = n(d[0], d[1])), v !== c) f = 0,
    ...
    dv = {
        ...
        FeatureCollection: function(t, n) {
            for (var e = t.features,
            r = -1,
            i = e.length; ++r < i;) if (Zr(e[r].geometry, n)) return ! 0;
            return ! 1
        }
    },
    vv = {
        ...
        MultiPoint: function(t, n) {
            for (var e = t.coordinates,
            r = -1,
            i = e.length; ++r < i;) if (Gr(e[r], n)) return ! 0;
            return ! 1
        },
        LineString: function(t, n) {
        ...
        MultiLineString: function(t, n) {
            for (var e = t.coordinates,
            r = -1,
            i = e.length; ++r < i;) if (Jr(e[r], n)) return ! 0;
            return ! 1
        },
        Polygon: function(t, n) {
        ...
        MultiPolygon: function(t, n) {
            for (var e = t.coordinates,
            r = -1,
            i = e.length; ++r < i;) if (Qr(e[r], n)) return ! 0;
            return ! 1
        },
        GeometryCollection: function(t, n) {
            for (var e = t.geometries,
            r = -1,
            i = e.length; ++r < i;) if (Zr(e[r], n)) return ! 0;
            return ! 1
        }
    },
    _v = function(t) {
    ...
    Jv = function(t) {
        for (var n, e, r = 0,
        i = (t = so(Gv.call(t))).length, o = []; r < i;) n = t[r],
        e && ho(e, n) ? ++r: (e = vo(o = fo(o, n)), r = 0);
        return e
    },
    Qv = function(t) {
        return function() {
    ...
    a_ = function t(n) {
        function e(t, e, r, i, o) {
            ...
            p = t.value; ++l < h;) {
                ...
                p -= a.value
            } else t._squarify = u = Yo(n, t, e, r, i, o),
            u.ratio = n
        }
        return e.ratio = function(n) {
            return t((n = +n) > 1 ? n: 1)
    ...
    Hg = +new Date("2000-01-01T00:00:00.000Z") ?
    function(t) {
        var n = new Date(t);
    ...
    Ty = function() {
        function t(t) {
            ...
            l = !1;
            for (null == i && (u = o(s = ve())), a = 0; a <= f; ++a) ! (a < f && r(c = t[a], a, t)) === l && ((l = !l) ? u.lineStart() : u.lineEnd()),
    ...
    mc.prototype = {
        ...
        lineEnd: function() {
            ...
            else for (var r = xc(t), i = xc(n), o = 0, u = 1; u < e; ++o, ++u) this._context.bezierCurveTo(r[0][o], i[0][o], r[1][o], i[1][o], t[u], n[u]); (this._line || 0 !== this._line && 1 === e) && this._context.closePath(),
            this._line = 1 - this._line,
            this._x = this._y = null
        },
        point: function(t, n) {
    ...
    kc.prototype = {
        ...
        insert: function(t, n) {
            ...
            for (n.L = n.R = null, n.U = e, n.C = !0, t = n; e && e.C;) e === (r = e.U).L ? (i = r.R) && i.C ? (e.C = i.C = !1, r.C = !0, t = r) : (t === e.R && (Ec(this, e), e = (t = e).U), e.C = !1, r.C = !0, Ac(this, r)) : (i = r.L) && i.C ? (e.C = i.C = !1, r.C = !0, t = r) : (t === e.L && (Ac(this, e), e = (t = e).U), e.C = !1, r.C = !0, Ec(this, r)),
            e = t.U;
            this._.C = !1
        },
        remove: function(t) {
            ...
            o = t.L,
            u = t.R;
            if (e = o ? u ? Cc(u) : o: u, i ? i.L === t ? i.L = e: i.R = e: this._ = e, o && u ? (r = e.C, e.C = t.C, e.L = o, o.U = e, e !== u ? (i = e.U, e.U = t.U, t = e.R, i.L = t, e.R = u, u.U = e) : (e.U = i, i = e, t = e.R)) : (r = t.C, t = e), t && (t.U = i), !r) if (t && t.C) t.C = !1;
            else {
                do {
                    if (t === this._) break;
                    if (t === i.L) {
    ...
    t.histogram = function() {
        function t(t) {
            ...
            for (o = 0; o <= p; ++o)(d = v[o] = []).x0 = o > 0 ? h[o - 1] : f,
            d.x1 = o < p ? h[o] : l;
    ...
    t.mean = function(t, n) {
        ...
        o = -1,
        u = 0;
        if (null == n) for (; ++o < r;) isNaN(e = _s(t[o])) ? --i: u += e;
        else for (; ++o < r;) isNaN(e = _s(n(t[o], o, t))) ? --i: u += e;
        if (i) return u / i
    },
    t.median = function(t, n) {
        ...
        i = -1,
        o = [];
        if (null == n) for (; ++i < r;) isNaN(e = _s(t[i])) || o.push(e);
        else for (; ++i < r;) isNaN(e = _s(n(t[i], i, t))) || o.push(e);
    ...
    t.pairs = function(t, n) {
        ...
        for (var r = 0,
        i = t.length - 1,
        o = t[0], u = new Array(i < 0 ? 0 : i); r < i;) u[r] = n(o, o = t[++r]);
        return u
    },
    ...
    t.chord = function() {
        function t(t) {
            ...
            for (s = -1; ++s < l;) for (f = s - 1; ++f < l;) {
                var M = g[f * l + s],
                T = g[s * l + f]; (M.value || T.value) && v.push(M.value < T.value ? {
                    source: T,
                    target: M
                }: {
                    source: M,
    ...
    t.ribbon = function() {
        function t() {
            ...
            _ = i.apply(this, a) - Oh,
            g = o.apply(this, a) - Oh;
            if (u || (u = t = ve()), u.moveTo(p, d), u.arc(0, 0, f, l, h), l === _ && h === g || (u.quadraticCurveTo(0, 0, v * qh(_), v * Uh(_)), u.arc(0, 0, v, _, g)), u.quadraticCurveTo(0, 0, p, d), u.closePath(), t) return u = null,
            t + "" || null
        }
        var n = _e,
        e = ge,
    ...
    t.nest = function() {
        function t(n, i, u, a) {
            ...
            for (var c, s, f, l = -1,
            h = n.length,
            p = o[i++], d = we(), v = u(); ++l < h;)(f = d.get(c = p(s = n[l]) + "")) ? f.push(s) : d.set(c, [s]);
    ...
    t.drag = function() {
        ...
        function c(e, r, i, o, u) {
            var a, c, s, f = i(r, e),
            l = m.copy();
            if (k(new gt(n, "beforestart", a, e, x, f[0], f[1], 0, 0, l),
            function() {
    ...
    t.forceCollide = function(t) {
        function n() {
            ...
            p = 0; p < a; ++p) for (n = qe(i, Oe, Fe).visitAfter(e), t = 0; t < h; ++t) r = i[t],
            f = o[r.index],
            l = f * f,
            c = r.x + r.vx,
            s = r.y + r.vy,
    ...
    t.forceManyBody = function() {
        ...
        function r(t, n, e, r) {
            ...
            h = r - n,
            p = i * i + c * c;
            if (h * h / l < p) return p < f && (0 === i && (i = fp(), p += i * i), 0 === c && (c = fp(), p += c * c), p < s && (p = Math.sqrt(s * p)), o.vx += i * t.value * u / p, o.vy += c * t.value * u / p),
            !0;
            if (! (t.length || p >= f)) { (t.data !== o || t.next) && (0 === i && (i = fp(), p += i * i), 0 === c && (c = fp(), p += c * c), p < s && (p = Math.sqrt(s * p)));
                do {
    ...
    t.geoBounds = function(t) {
        ...
        if (Fp = Op = -(Up = Dp = 1 / 0), Hp = [], Cd(t, qd), e = Hp.length) {
            ...
            (a = xr(r[1], i[0])) > u && (u = a, Up = i[0], Op = r[1])
        }
        return Hp = Xp = null,
    ...
    t.tree = function() {
        ...
        function r(t, n, e) {
            if (n) {
                ...
                u = t,
                a = n,
                c = i.parent.children[0], s = i.m, f = u.m, l = a.m, h = c.m; a = qo(a), i = Lo(i), a && i;) c = Lo(c),
                (u = qo(u)).a = t,
                (r = a.z + l - i.z - s + o(a._, i._)) > 0 && (Uo(Oo(a, t, e), t, r), s += r, f += r),
                l += a.m,
                s += i.m,
                h += c.m,
                f += u.m;
    ...
    t.treemapDice = t_,
    t.treemapSlice = i_,
    t.treemapSliceDice = function(t, n, e, r, i) { (1 & t.depth ? i_: t_)(t, n, e, r, i)
    },
    ...
    t.touches = function(t, n) {
        null == n && (n = Ks().touches);
        for (var e = 0,
        r = n ? n.length: 0, i = new Array(r); e < r; ++e) i[e] = tf(t, n[e]);
        return i
    },
    t.window = cf,
    t.customEvent = k,
    t.arc = function() {
        function t() {
            ...
            d = hy(p - h),
            v = p > h;
            if (c || (c = t = ve()), l < f && (s = l, l = f, f = s), l > my) if (d > wy - my) c.moveTo(l * dy(h), l * gy(h)),
            c.arc(0, 0, l, h, p, !v),
            f > my && (c.moveTo(f * dy(p), f * gy(p)), c.arc(0, 0, f, p, h, v));
            else {
                var _, g, y = h,
                m = p,
                x = h,
                ...
                if (N > my) {
                    var A = Pa(N / f * gy(T)),
                    C = Pa(N / l * gy(T)); (w -= 2 * A) > my ? (A *= v ? 1 : -1, x += A, b -= A) : (w = 0, x = b = (h + p) / 2),
    ...
    t.pie = function() {
        function t(t) {
            ...
            for (null != e ? d.sort(function(t, n) {
                ...
                return r(t[n], t[e])
            }), a = 0, s = p ? (g - h * m) / p: 0; a < h; ++a, _ = f) c = d[a],
            f = _ + ((l = v[c]) > 0 ? l * s: 0) + m,
            v[c] = {
                data: t[c],
                index: a,
    ...
    t.symbol = function() {
        function t() {
            var t;
            if (r || (r = t = ve()), n.apply(this, arguments).draw(r, +e.apply(this, arguments)), t) return r = null,
            t + "" || null
        }
        var n = ly(Ry),
        e = ly(64),
    ...
    t.active = function(t, n) {
        ...
        if (i) {
            n = null == n ? null: n + "";
            for (r in i) if ((e = i[r]).state > Ol && e.name === n) return new Gn([[t]], mh, n, +r)
        }
        return null
    },
    t.interrupt = Xl,
    ...
    t.zoom = function() {
        ...
        function a(t, n) {
            for (var e, r = 0,
            i = z.length; r < i; ++r) if ((e = z[r]).that === t) return e;
            return new c(t, n)
        }
        function c(t, n) {
            this.that = t,
        ...
        function s() {
            if (y.apply(this, arguments)) {
                ...
                u = nf(this);
                if (t.wheel) t.mouse[0][0] === u[0] && t.mouse[0][1] === u[1] || (t.mouse[1] = n.invert(t.mouse[0] = u)),
        ...
        function f() {
            if (!g && y.apply(this, arguments)) {
                ...
                e = ff(t.event.view).on("mousemove.zoom",
                function() {
                    if (xm(), !n.moved) {
        ...
        function d() {
            ...
            l = f.length;
            for (xm(), _ && (_ = clearTimeout(_)), n = 0; n < l; ++n) o = f[n],
